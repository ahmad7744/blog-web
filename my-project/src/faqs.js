...
const faqs = () => {
  return (
        ...
        <>
            <div className="bg-gray-100 md:py-32 py-8 sm:py-16 mx-auto">
                <div className="container mx-auto  ">
                    <div role="article" className="bg-gray-100 max-w-7xl  mx-auto">
                            ...
                            <div className="flex flex-col lg:flex-row flex-wrap">
                                ...
                                <div className="lg:w-2/5 flex mt-10 ml-2 lg:ml-0 lg:mt-0 lg:justify-end">
                                    <div className="pt-2 relative  text-gray-600">
                                        <input className="focus:ring-2 focus:ring-offset-2 focus:ring-gray-400 bg-white h-10 px-3 pr-16 rounded-lg text-sm focus:outline-none" type="search" name="search" placeholder="Search" />
