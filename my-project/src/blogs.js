            ...
            <div>
                ...
                <div class="w-full h-full bg-white  px-5 ">
                    <div className='flex-col justify-center '>
                        ...
                        <Link to="/detail/7"><p className='text-center cursor-pointer  opacity-70 mt-1 sm:mt-2 md:mt-4 text-indigo-700 text-[10px] md:text-[16px] sm:text-[14px] font-normal '>Read More</p></Link>
                    </div>
